...
/**
 * Created by rentm on 2017/1/15.
 */

public class VehicleNumberKeyboard extends AbstractKeyboard {
    ...
    public VehicleNumberKeyboard(Context context, OnKeyActionListener keyActionListener) {
...
//                }
    ...
    public static void show(Activity activity, OnKeyActionListener listener) {
        new VehicleNumberKeyboard(activity, listener).show(activity.getWindow().getDecorView().getRootView());
    }

    public static VehicleNumberKeyboard create(Context context, OnKeyActionListener listener) {
        return new VehicleNumberKeyboard(context, listener);
    }
}
